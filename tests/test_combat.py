...
class TestCombat(unittest.TestCase):
    ...
    def test_initiative(self):
        player = Player(1, 10, 16, 16, 12, 10, 8, 8, 15, "AggroSec", "2d6", {}, "Axe", "Chop")
        enemy1 = EnemyNPC(1, 5, 10, 8, 6, 8, 8, 8, 8, "Goblin", "1d4", 0, "dagger", "stab")
        enemy2 = EnemyNPC(1, 3, 10, 8, 16, 8, 8, 8, 8, "Goblin Skirmisher", "1d4", 0, "dagger", "stab")
